...
public class GamepadManager
{
    ...
    private short StickThreshold = 5000;
    ...
    public void SetThumbstickDeadzone(short deadzone) { StickThreshold = deadzone; }
    public short GetThumbstickDeadzone() { return StickThreshold; }
